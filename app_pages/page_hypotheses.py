...
def hypothesis_body():
    ...
    st.success(
        f"1. **Default on previous loan(s) makes it unlikely to guarantee\n"
        f"a free risk loan (free of default) **.\n"
        ...
        f"2. **The higher the loan-to-income ratio, the higher\n"
        f"the probability of loan default**.\n"
        ...
        f"3. **However high a person's income, it does not impact\n"
        f"no default if the loan-to-income ratio is below\n"
        f"a defined threshold**.\n"
        ...
        f"the likelihood of no default is guaranteed.**\n"
